// Create Your Own Contract : Write your own contract that interacts with the provided BadMarket contract to solve the challenge.

// Test Locally: Before deploying, test your contract locally to ensure it works properly.

// Deploy and Verify: Once your contract is working, deploy it and verify the solution on NodeGuardians.
