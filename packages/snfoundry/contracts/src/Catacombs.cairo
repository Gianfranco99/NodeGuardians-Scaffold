//Hint:You need to create your own contract in order to call the write function of this contract and change the values of the variables stored in the contract's storage.
